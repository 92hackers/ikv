/**
 * Define Storage engine interfaces.
 */
...
mod tests {
    ...
    #[test] // Flag the function as a testcase
    fn memtable_get_all_should_work() {
        let store = MemTable::new();
        test_get_all(store);
    }

    // The argument type is: an implementation of a trait.
    ...
    // `impl <trait> means: The type is an implementation of a trait`
